...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.1912.403 at 3:57 PM on Tuesday, February 2, 2021.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		public Bernoulli secondCoin_marginal;
		#endregion
		...
		private void Changed_secondCoin()
		{
			...
			this.secondCoin_marginal = Bernoulli.Uniform();
			this.secondCoin_marginal = Distribution.SetPoint<Bernoulli,bool>(this.secondCoin_marginal, this.SecondCoin);
		...
		{
			return this.secondCoin_marginal;
		}
